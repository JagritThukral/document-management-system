<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HawkinsDMS._Default" %>

<asp:Content ID="head" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="<%= Page.ResolveUrl("~/Content/home.css") %>" />
</asp:Content>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <section aria-labelledby="actions-title">
        <h1 class="page-header">Hello There!</h1>
        <h2 id="actions-title" class="hidden">Document Management System Actions</h2>
        <div class="card-grid">
            <a class="card" href="/search">
                <article class="card__content">
                    ...
                    <p class="card__text">Find content in documents instantly</p>
                </article>
            </a>
            <a class="card" href="/upload">
                <article class="card__content">
                    <div>
                        <div class="card__icon">
                            <svg role="img" data-slot="icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd" d="M5.625 1.5H9a3.75 3.75 0 0 1 3.75 3.75v1.875c0 1.036.84 1.875 1.875 1.875H16.5a3.75 3.75 0 0 1 3.75 3.75v7.875c0 1.035-.84 1.875-1.875 1.875H5.625a1.875 1.875 0 0 1-1.875-1.875V3.375c0-1.036.84-1.875 1.875-1.875Zm6.905 9.97a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 1 0 1.06 1.06l1.72-1.72V18a.75.75 0 0 0 1.5 0v-4.19l1.72 1.72a.75.75 0 1 0 1.06-1.06l-3-3Z"></path>
                        ...
                        <h2 class="card__title">Upload</h2>

                    </div>
                    <p class="card__text">Add new documents to vault</p>
                </article>
            </a>
            <a class="card" href="/documents">
                <article class="card__content">
                    ...
                    <p class="card__text">Explore all documents in vault</p>
                </article>
            </a>
            <a class="card" href="/chat">
                <article class="card__content">
                    ...
                    <p class="card__text">Chat with AI about documents</p>
                </article>
            </a>
        </div>
    </section>
